...
import ru.aibok.auth.dto.AuthRequest;
import ru.aibok.auth.dto.AuthResponse;
import ru.aibok.auth.dto.RegisterRequest;
import ru.aibok.auth.model.Role;
import ru.aibok.auth.model.User;
import ru.aibok.auth.repository.RoleRepository;
import ru.aibok.auth.repository.UserRepository;
